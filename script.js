...
function desenharPreview() {
  ...
  // Se estiver exportando, esconde o HTML para o Canvas renderizar sozinho
  elemento.style.opacity = estaExportando ? "0" : "1";
  
  // Se NÃO estiver exportando, o HTML faz o trabalho do preview e o Canvas pula o desenho para não duplicar
